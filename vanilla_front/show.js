...
function houseWinner(house){
    ...
    const newestCharacter = house["characters"][newestCharacterIndex]["name"]
        ...
        houseSpells1.innerHTML = `<a style='color:blue' href="http://localhost:3001/showspells.html?id=${spell1.id}">${spell1["name"]}</a>`
        houseSpells2.innerHTML = `<a style='color:blue' href="http://localhost:3001/showspells.html?id=${spell2.id}">${spell2["name"]}</a>`
        houseSpells3.innerHTML = `<a style='color:blue' href="http://localhost:3001/showspells.html?id=${spell3.id}">${spell3["name"]}</a>`
